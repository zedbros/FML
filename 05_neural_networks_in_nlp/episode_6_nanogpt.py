...
from preprocessing import load_text, build_vocabulary, prepare_data_splits, get_batch as get_batch_fn, encode as encode_fn, decode as decode_fn
...
encode = lambda s: encode_fn(s, char_to_idx)
decode = lambda l: decode_fn(l, idx_to_char)
...
def get_batch(split):
    ...
    return get_batch_fn(data, block_size, batch_size, device)
